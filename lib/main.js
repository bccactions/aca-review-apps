...
function main() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const baseContainerConfig = Object.assign({ "name": taskParams.containerAppName, "image": taskParams.imageName }, (taskParams.environmentVariables.length > 0 && {
                env: taskParams.environmentVariables.map(e => {
                    const [name, value] = e.split('=');
                    return { name, value };
                })
            }));
            const containerConfig = [baseContainerConfig];
